...
const _mulberrySymbols = <String, _SymbolSpec>{
  ...
  'chew': _SymbolSpec('Kunyah', ['kunyah', 'mengunyah'], 'chew_,_to.svg', 'Kata kerja'),
  'brush_teeth': _SymbolSpec('Gosok gigi', ['gosok gigi', 'sikat gigi'], 'brush_teeth_,_to.svg', 'Kata kerja'),
  'write': _SymbolSpec('Nulis', ['nulis', 'menulis'], 'write_,_to.svg', 'Kata kerja'),
  'read': _SymbolSpec('Baca', ['baca', 'membaca'], 'read_,_to.svg', 'Kata kerja'),
  'draw': _SymbolSpec('Gambar', ['gambar', 'menggambar'], 'draw_,_to.svg', 'Kata kerja'),
  'sing': _SymbolSpec('Nyanyi', ['nyanyi', 'bernyanyi'], 'sing_,_to.svg', 'Kata kerja'),
  'cut': _SymbolSpec('Potong', ['potong', 'memotong'], 'cut_,_to.svg', 'Kata kerja'),
  'hold': _SymbolSpec('Pegang', ['pegang', 'memegang'], 'hold_,_to.svg', 'Kata kerja'),
  'catch': _SymbolSpec('Tangkap', ['tangkap', 'menangkap'], 'catch_,_to.svg', 'Kata kerja'),
  'bathe': _SymbolSpec('Mandi', ['mandi'], 'bathe_,_to.svg', 'Kata kerja'),
  'get_dressed': _SymbolSpec('Pakai baju', ['pakai baju', 'berpakaian'], 'get_dressed_,_to.svg', 'Kata kerja'),
  ...
  'confused': _SymbolSpec('Bingung', ['bingung'], 'confused_man.svg', 'Perasaan'),
  'surprised': _SymbolSpec('Kaget', ['kaget', 'terkejut'], 'surprised_man.svg', 'Perasaan'),
  'sleepy': _SymbolSpec('Ngantuk', ['ngantuk', 'mengantuk'], 'yawn_,_to.svg', 'Perasaan'),
  ...
  'melon': _SymbolSpec('Melon', ['melon'], 'melon.svg', 'Makanan'),
  'meat': _SymbolSpec('Daging', ['daging'], 'meat.svg', 'Makanan'),
  'cheese': _SymbolSpec('Keju', ['keju'], 'cheese.svg', 'Makanan'),
  ...
  'grandpa': _SymbolSpec('Atok', ['atok', 'kakek', 'engkong'], 'grandfather.svg', 'Keluarga'),
  'grandma': _SymbolSpec('Nenek', ['nenek', 'oma'], 'grandmother.svg', 'Keluarga'),
  ...
  'purple': _SymbolSpec('Ungu', ['ungu'], 'purple.svg', 'Warna'),
  'orange': _SymbolSpec('Oranye', ['oranye', 'jingga'], 'orange.svg', 'Warna'),
  'grey': _SymbolSpec('Abu-abu', ['abu-abu', 'abu abu'], 'grey_dark.svg', 'Warna'),
  'pink': _SymbolSpec('Merah muda', ['merah muda', 'pink'], 'pink.svg', 'Warna'),
  ...
  'left': _SymbolSpec('Kiri', ['kiri'], 'left.svg', 'Konsep'),
  'right': _SymbolSpec('Kanan', ['kanan'], 'right.svg', 'Konsep'),
  ...
  'bed': _SymbolSpec('Kasur', ['kasur', 'kamar tidur', 'tempat tidur'], 'single_bed.svg', 'Tempat & benda'),
  'tv': _SymbolSpec('TV', ['tv', 'televisi'], 'tv_drama.svg', 'Tempat & benda'),
  'phone': _SymbolSpec('HP', ['hp', 'handphone', 'telepon'], 'mobile_phone.svg', 'Tempat & benda'),
  'sofa': _SymbolSpec('Sofa', ['sofa', 'ruang tamu'], 'settee_1.svg', 'Tempat & benda'),
  'motorcycle': _SymbolSpec('Motor', ['motor'], 'motorcycle.svg', 'Tempat & benda'),
  'shirt': _SymbolSpec('Baju', ['baju', 'kaos'], 'shirt.svg', 'Tempat & benda'),
  'trousers': _SymbolSpec('Celana', ['celana'], 'trousers.svg', 'Tempat & benda'),
  'skirt': _SymbolSpec('Rok', ['rok'], 'skirt.svg', 'Tempat & benda'),
  'jacket': _SymbolSpec('Jaket', ['jaket'], 'jacket.svg', 'Tempat & benda'),
  'hat': _SymbolSpec('Topi', ['topi'], 'hat_-_mans.svg', 'Tempat & benda'),
  'helmet': _SymbolSpec('Helm', ['helm'], 'helmet.svg', 'Tempat & benda'),
  'shoes': _SymbolSpec('Sepatu', ['sepatu'], 'shoe_-_mans.svg', 'Tempat & benda'),
  'sandals': _SymbolSpec('Sandal', ['sandal'], 'sandals.svg', 'Tempat & benda'),
  'socks': _SymbolSpec('Kaus kaki', ['kaus kaki', 'kaos kaki'], 'socks.svg', 'Tempat & benda'),
  'comb': _SymbolSpec('Sisir', ['sisir'], 'comb.svg', 'Tempat & benda'),
  'stairs': _SymbolSpec('Tangga', ['tangga'], 'stairs.svg', 'Tempat & benda'),
  'sink': _SymbolSpec('Wastafel', ['wastafel'], 'sink.svg', 'Tempat & benda'),
  'door': _SymbolSpec('Pintu', ['pintu'], 'door.svg', 'Tempat & benda'),
  'window': _SymbolSpec('Jendela', ['jendela'], 'window.svg', 'Tempat & benda'),
  'remote': _SymbolSpec('Remote', ['remote'], 'remote_control.svg', 'Tempat & benda'),
  'plate': _SymbolSpec('Piring', ['piring'], 'plate.svg', 'Tempat & benda'),
  'glass': _SymbolSpec('Gelas', ['gelas'], 'glass.svg', 'Tempat & benda'),
  'spoon': _SymbolSpec('Sendok', ['sendok'], 'spoon.svg', 'Tempat & benda'),
  'fork': _SymbolSpec('Garpu', ['garpu'], 'fork.svg', 'Tempat & benda'),
  'table': _SymbolSpec('Meja', ['meja'], 'table.svg', 'Tempat & benda'),
  'chair': _SymbolSpec('Kursi', ['kursi'], 'chair.svg', 'Tempat & benda'),
  'pencil': _SymbolSpec('Pensil', ['pensil'], 'pencil.svg', 'Tempat & benda'),
  'bicycle': _SymbolSpec('Sepeda', ['sepeda'], 'bicycle.svg', 'Tempat & benda'),
  'bus': _SymbolSpec('Bis', ['bis', 'bus'], 'bus.svg', 'Tempat & benda'),
  'train': _SymbolSpec('Kereta', ['kereta'], 'train.svg', 'Tempat & benda'),
  'airplane': _SymbolSpec('Pesawat', ['pesawat'], 'aeroplane.svg', 'Tempat & benda'),
  'umbrella': _SymbolSpec('Payung', ['payung'], 'umbrella.svg', 'Tempat & benda'),
  ...
  'snake': _SymbolSpec('Ular', ['ular'], 'snake.svg', 'Hewan'),
  'sheep': _SymbolSpec('Domba', ['domba'], 'sheep.svg', 'Hewan'),
  'rooster': _SymbolSpec('Ayam', ['ayam'], 'cockerel.svg', 'Hewan'),
  'crocodile': _SymbolSpec('Buaya', ['buaya'], 'crocodile.svg', 'Hewan'),
  'rabbit': _SymbolSpec('Kelinci', ['kelinci'], 'rabbit.svg', 'Hewan'),
  'elephant': _SymbolSpec('Gajah', ['gajah'], 'elephant.svg', 'Hewan'),
  'lion': _SymbolSpec('Singa', ['singa'], 'lion.svg', 'Hewan'),
  'horse': _SymbolSpec('Kuda', ['kuda'], 'horse.svg', 'Hewan'),
  'butterfly': _SymbolSpec('Kupu-kupu', ['kupu-kupu', 'kupu kupu'], 'butterfly.svg', 'Hewan'),
  ...
  'zero': _SymbolSpec('Nol', ['nol', '0'], 'Zero.svg', 'Angka'),
  'four': _SymbolSpec('Empat', ['empat', '4'], 'four.svg', 'Angka'),
  'five': _SymbolSpec('Lima', ['lima', '5'], 'five.svg', 'Angka'),
  'six': _SymbolSpec('Enam', ['enam', '6'], 'six.svg', 'Angka'),
  'seven': _SymbolSpec('Tujuh', ['tujuh', '7'], 'seven.svg', 'Angka'),
  'eight': _SymbolSpec('Delapan', ['delapan', '8'], 'eight.svg', 'Angka'),
  'nine': _SymbolSpec('Sembilan', ['sembilan', '9'], 'nine.svg', 'Angka'),
  'ten': _SymbolSpec('Sepuluh', ['sepuluh', '10'], 'ten.svg', 'Angka'),
};
